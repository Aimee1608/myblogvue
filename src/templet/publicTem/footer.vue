...
<template>
    ...
    <div v-if="this.$store.state.themeObj.user_start!=0" class="footBack footBackQian">
        ...
        <div class="fcontainer">
            ...
            <p>
                © 2018 <a href="#">Mango Ya</a>. 由 <a href="https://cn.vuejs.org/" target="_blank">Vue</a> 强力驱动. Theme By <a href="#">diygod.me</a>. 京ICP备17071595号-1.
            </p>
            <p>
    ...
    <div v-else class="footBack footBackHui">
        ...
        <div class="fcontainer">
            ...
            <p>
                © 2018 <a href="#">QinlhBlog</a>. 由 <a href="https://cn.vuejs.org/" target="_blank">Vue</a> 强力驱动. Theme By <a href="#">diygod.me</a>. 京ICP备17071595号-1.
            </p>
            <p>
                <span>Made with</span> <img class="fheart" src="src/img/heart02.png"/>  <span>by Qinlh.</span>
            </p>
        </div>
    </div>
...
<script>
    export default {
        data() { //选项 / 数据
            return {
                footBg:"url(/src/img/footer01.png) no-repeat 50%",//底部图片
                longTime:'',
            }
        },
        methods: { //事件处理器
